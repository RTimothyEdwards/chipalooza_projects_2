 ...
 * 2) set GPIO 10 to digital output.
 ...
 * 2) power supply is monitored on GPIO 17.
 * 3) present analog input on GPIO 11 and 13.
 * 4) view digital output on GPIO 10
 *
 * Measurements:  Measure systematic input offset.
 */
...
void config_io() {
    ...
    reg_mprj_io_10 = GPIO_MODE_USER_STD_OUTPUT;		/* output */
