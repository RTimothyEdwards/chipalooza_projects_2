...
#define AUDDAC_PWR_ENABLE	0x00000200
#define OSC16M_PWR_ENABLE	0x00000400
#define CDAC_PWR_ENABLE		0x00000800
#define CCOMP_PWR_ENABLE	0x00001000
#define VREF_PWR_ENABLE		0x00002000
#define LDO_PWR_ENABLE		0x00004000
#define IDAC_PWR_ENABLE		0x00008000
#define OSC500K_PWR_ENABLE	0x00010000
#define SAMPLE_PWR_ENABLE	0x00020000
#define ULPCOMP_PWR_ENABLE	0x00040000
#define INSTRAMP_PWR_ENABLE	0x00080000
#define POR_PWR_ENABLE		0x00100000
#define RHEO_PWR_ENABLE		0x00200000
#define RDAC_PWR_ENABLE		0x00400000
