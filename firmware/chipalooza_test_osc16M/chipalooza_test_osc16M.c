 ...
 *    except for GPIO 32, which is a user digital output.
 ...
 * 3) power supply monitor is GPIO 20 (no ESD protection)
 * 7) view digital output on GPIO 32.
 *
...
void config_io() {
    ...
    reg_mprj_io_32 = GPIO_MODE_USER_STD_OUTPUT;		/* digital out */
