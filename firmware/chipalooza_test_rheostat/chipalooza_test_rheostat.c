 ...
 * response.  Output should be a sawtooth wave, although
 * actual measurement should be the resistance from the
 * low reference to the output, and the resistance from the
 * output to the high reference.
 *-----------------------------------------------------------
 *
 * 1) enable power supply for the rheostat
 * 2) power supply is monitored on GPIO 15.
 ...
 * GPIO 3 and 4 to digital inputs and setting GPIO 3 high
 * (3.3V) and GPIO 4 low (0V).  Redo all measurements.
 * Do not apply reference voltages to GPIO 8 and GPIO 10
 * in this mode.
 *
 * Set GPIO 3 to an input pull-up and GPIO 4 to an input
